  ...
  const items = [
    {
      id: 0,
      link:
        'https://adityaiitd.tech',
      linkTitle: 'View project',
      preview: preview1,
      tags: 'Portfolio, Personal Website, Founder',
      title: 'Portfolio of founder of Glance Labs',
      alt: 'Personal Portfolio — Aditya Kumar',
      imgTitle: 'Personal Portfolio — Aditya Kumar',
      technologies: [
